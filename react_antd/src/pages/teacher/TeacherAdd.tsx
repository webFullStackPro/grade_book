...
interface TeacherAddProps {
  visible: boolean;
  id: number;
  onCloseTeacherAdd: () => void;
}

const TeacherAdd: React.FC<TeacherAddProps> = ({visible, id, onCloseTeacherAdd}) => {
  ...
  const [title, setTitle] = useState('新增教师信息');
  ...
  return (
    <Modal title={title} open={visible} onCancel={onCloseTeacherAdd} width={'var(--modal-width)'} footer={addFooter} style={{marginTop: 'var(--modal-margin-top)'}}>
