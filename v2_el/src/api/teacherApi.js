...
export default class teacherApi {
  ...
  static async save (params) {
    console.log('teacherApi save params', params)
    const response = await mockApi.operateSuccessfully()
    return response.data
  }

  static async find (params) {
    console.log('teacherApi find params', params)
    const response = await mockApi.queryPageSuccessfully(teacherApi.teachers)
    return response.data
  }
